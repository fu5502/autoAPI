    ...
    <div className="drawer-layer open">
      ...
      <aside className="drawer" role="dialog" aria-modal="true" aria-labelledby="provider-title">
        ...
        <form ref={formRef} onSubmit={submit}>
          ...
          <div className="field"><label htmlFor="faviconUrl">自定义渠道图标 <small>可选，留空自动获取，支持 HTTPS 或 Data URL</small></label><input id="faviconUrl" name="faviconUrl" type="text" inputMode="url" autoCapitalize="none" spellCheck={false} placeholder="https://example.com/icon.png 或 data:image/svg+xml,..." /></div>
